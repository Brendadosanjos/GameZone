    ...
    return (
      <div className="bg-[#F9F8FE] min-h-screen">
        ...
        <div className="flex flex-col items-center justify-center h-[500px] gap-5">
          ...
          <h2 className="text-[#1F1F1F] font-extrabold text-[28px]">
            Pagamento confirmado!
          </h2>
          <p className="text-[#474747] text-[15px]">
            Seu pedido foi realizado com sucesso. Redirecionando...
          </p>
        </div>
        <Footer />
      </div>
        ...
        <div className="flex gap-[40px] items-start">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-[16px] p-6 shadow-sm">
              <p className="text-[#1F1F1F] font-bold text-[16px] mb-4">
                Forma de pagamento
              </p>
            ...
            {paymentMethod === "cartao" && (
              <div className="bg-white rounded-[16px] p-6 shadow-sm flex flex-col gap-4">
                <p className="text-[#1F1F1F] font-bold text-[16px]">
                  Dados do cartão
                </p>
                ...
                <div className="bg-gradient-to-br from-[#2074c9] to-[#1a3a6b] rounded-[14px] p-5 text-white h-[160px] flex flex-col justify-between">
                  ...
                  <div>
                    <p className="font-mono text-[18px] tracking-[4px] mb-2">
                      {cardNumber || "•••• •••• •••• ••••"}
                    </p>
            ...
            {paymentMethod === "pix" && (
              <div className="bg-white rounded-[16px] p-6 shadow-sm flex flex-col items-center gap-4">
                <p className="text-[#1F1F1F] font-bold text-[16px] self-start">
                  Pague via PIX
                </p>
                <div className="w-[180px] h-[180px] bg-[#F5F5F5] rounded-[12px] flex items-center justify-center text-[80px]">
                  ⬛
                </div>
                <p className="text-[#474747] text-[13px] text-center max-w-[300px]">
                  Escaneie o QR Code acima com o app do seu banco ou copie o código PIX abaixo.
                </p>
                <div className="flex gap-2 w-full">
                  <input
                    readOnly
                    value="00020126580014br.gov.bcb.pix0136gamezone-fake-pix-key"
                    className="flex-1 h-[40px] border border-[#E8E8E8] rounded-[8px] px-3 text-[12px] text-[#8F8F8F] bg-[#F9F8FE]"
                  />
                  <button
                    onClick={() => navigator.clipboard.writeText("00020126580014br.gov.bcb.pix0136gamezone-fake-pix-key")}
                ...
                <p className="text-[#8F8F8F] text-[12px]">
                  ⏱ Código válido por <strong>30 minutos</strong>
                </p>
              </div>
            )}
            ...
            {paymentMethod === "boleto" && (
              <div className="bg-white rounded-[16px] p-6 shadow-sm flex flex-col gap-4">
                ...
                <div className="bg-[#F9F8FE] rounded-[10px] p-4 flex flex-col gap-2">
                  ...
                  <p className="text-[#474747] text-[13px]">
                    ⏳ O pedido será confirmado em até <strong>2 dias úteis</strong> após o pagamento.
                  </p>
                </div>
                <div className="flex gap-2">
                  <input
                    readOnly
                    value="34191.75400 00000.000004 00000.000000 1 00000000000000"
                    className="flex-1 h-[40px] border border-[#E8E8E8] rounded-[8px] px-3 text-[12px] text-[#8F8F8F] bg-[#F9F8FE]"
                  />
                  <button
                    onClick={() => navigator.clipboard.writeText("34191.75400 00000.000004 00000.000000 1 00000000000000")}
                    className="bg-[#2074c9] text-white font-bold text-[12px] px-4 rounded-[8px] hover:bg-[#1a5faa] transition-colors"
                  >
                    Copiar
                  </button>
              ...
              <div className="flex flex-col gap-3 mb-4">
                {cartItems.map((item) => (
                  <div key={item.docId} className="flex items-center gap-3">
                    ...
                    <p className="text-[#474747] text-[13px] flex-1 line-clamp-2">
                      {item.title}
                    </p>
