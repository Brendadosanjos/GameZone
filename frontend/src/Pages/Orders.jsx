                  ...
                  <div className="flex items-center justify-between px-6 py-4 border-b border-[#F0F0F0]">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#1F1F1F] font-semibold text-[14px]">
                    ...
                    {/* Status */}
                    <span
                      className={`text-[12px] font-bold px-4 py-1 rounded-full ${statusStyle.bg} ${statusStyle.text}`}
                    >
                    ...
                    {items.map((item, i) => (
                      <div key={i} className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[#1F1F1F] font-bold text-[14px] truncate">
                            {item.title}
                          </p>
